...
The standard model of cosmology is tested by comparing theoretical predictions against observations from galaxy surveys such as DESI \citep{desi2025v, desi2025vii} and CMB experiments including Planck \citep{planck2020}.
...
The dominant Boltzmann codes---\class \citep{lesgourgues2011} and CAMB \citep{lewis2000}---are written in C and Fortran, are not differentiable, and are not GPU-native.
