...
The standard model of cosmology is tested by comparing theoretical predictions against observations from galaxy surveys such as DESI \citep{desi2016, desi2025v, desi2025vii} and Euclid \citep{euclid2024, euclid2026}, and CMB experiments including Planck \citep{planck2020}.
...
The dominant Boltzmann codes---\class \citep{lesgourgues2011, blas2011} and CAMB \citep{lewis2000}---are written in C and Fortran, are not differentiable, and are not GPU-native.
...
We describe the development of \clax and \claxpt---fully differentiable \jax reimplementations of the \class \citep{lesgourgues2011, blas2011} and \classpt \citep{chudaykin2021} pipelines---and the oracle-guided agentic methodology used to build them.
