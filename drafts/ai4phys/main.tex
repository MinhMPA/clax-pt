...
PyBird-JAX \citep{Reeves:2025bxn} and Effort.jl \citep{Bonici:2025ltp} take a complementary approach: they emulate the one-loop power spectrum multipoles using neural networks, achieving sub-millisecond evaluation but without computing the loop integrals directly.
