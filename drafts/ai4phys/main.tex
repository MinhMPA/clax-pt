...
Libraries such as NumPyro \citep{phan2019}, BlackJAX \citep{cabezas2024}, and adaptive MCMC with normalizing flows \citep{gabrie2022} provide state-of-the-art gradient-based samplers, but the missing ingredient is a differentiable cosmological forward model that can be passed to them.
...
SymBoltz.jl \citep{sletmoen2024} provides a full Boltzmann solver in Julia with automatic differentiation but without GPU support.
