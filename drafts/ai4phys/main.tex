...
The dominant Boltzmann codes---\class \citep{lesgourgues2011} and \textsc{CAMB} \citep{lewis2000}---are written in C and Fortran, are not differentiable, and are not GPU-native.
...
\Cref{fig:pipeline} shows the full pipeline architecture, including the two output branches (CMB spectra and galaxy power spectra) and the oracle test points.
