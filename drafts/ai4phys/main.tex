...
Even \emph{human} diagnoses can be wrong: the $m_p$/$m_H$ typo described above was initially attributed to ``RECFAST visibility function bias'' in the project documentation, and the suggested fix (switching to HyRec recombination) would not have helped---the actual root cause was a one-line constant error.
