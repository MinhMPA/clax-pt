...
This suggests that improving AI-assisted scientific software requires better supervision protocols at least as much as better models. Specifically, it requires protocols that distinguish predictive adequacy from explanatory correctness---the ``no fudge factors'' rule being a crude but effective instance that forces mechanistic explanations rather than calibrated patches.
