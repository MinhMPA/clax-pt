...
#### 2026-04-09 (revised) — ALL 9 SPECTRA PASS

| Observable    | k range [h/Mpc] | Max error  | Mean error | Metric      | Status | Target |
|---------------|----------------|------------|------------|-------------|--------|--------|
| P_mm real     | 0.005 – 0.30   | **0.94%**  | 0.12%      | relative    | ✅ PASS | < 1%   |
| P_gg real     | 0.005 – 0.30   | **0.94%**  | 0.12%      | relative    | ✅ PASS | < 1%   |
| P_gm real     | 0.005 – 0.30   | **0.94%**  | 0.12%      | relative    | ✅ PASS | < 1%   |
| P_mm ℓ=0     | 0.005 – 0.30   | **0.74%**  | 0.42%      | relative    | ✅ PASS | < 1%   |
| P_mm ℓ=2     | 0.005 – 0.30   | **0.70%**  | 0.45%      | relative    | ✅ PASS | < 1%   |
| P_mm ℓ=4     | 0.005 – 0.30   | **0.86%**  | 0.17%      | abs/max(ref)| ✅ PASS | < 2%   |
| P_gg ℓ=0     | 0.005 – 0.30   | **0.80%**  | 0.42%      | relative    | ✅ PASS | < 1%   |
| P_gg ℓ=2     | 0.005 – 0.30   | **0.94%**  | 0.50%      | relative    | ✅ PASS | < 1%   |
| P_gg ℓ=4     | 0.005 – 0.30   | **1.64%**  | 0.40%      | abs/max(ref)| ✅ PASS | < 2%   |
