...
class TestClTT:
    ...
    def test_cl_tt_l100(self, pipeline_fast_cl, lcdm_cls_ref):
    ...
    def test_cl_tt_l50(self, pipeline_fast_cl, lcdm_cls_ref):
    ...
    def test_cl_tt_l10(self, pipeline_fast_cl, lcdm_cls_ref):
    ...
    def test_cl_tt_positive(self, pipeline_fast_cl):
...
class TestClEE:
    ...
    def test_cl_ee_positive(self, pipeline_fast_cl):
    ...
    def test_cl_ee_finite(self, pipeline_fast_cl):
    ...
    def test_cl_ee_l100_accuracy(self, pipeline_fast_cl, lcdm_cls_ref):
    ...
    def test_cl_ee_l200_accuracy(self, pipeline_fast_cl, lcdm_cls_ref):
...
class TestClTE:
    ...
    def test_cl_te_sign(self, pipeline_fast_cl, lcdm_cls_ref):
    ...
    def test_cl_te_finite(self, pipeline_fast_cl):
    ...
    def test_cl_te_l100_accuracy(self, pipeline_fast_cl, lcdm_cls_ref):
